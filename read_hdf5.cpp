...
#include <hdf5/serial/hdf5.h>
#define FILE        "/home/nick/projects/fluids_viewer/build/particle_files/particles_pos_100000.h5"//"SDS.h5"
...
int main (void){
    ...
    if (class_t == H5T_INTEGER) printf("Data set has INTEGER type \n");
